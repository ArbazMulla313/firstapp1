...
export const Counter=()=>{
    ...
    return(
        <div>
         ...
         <Button variant='contained' color='success' onClick={()=>handleDecreament(+1)}>+</Button>
         <h1>{countVal}</h1>
         ...
         <Button variant='contained' color='success'  onClick={()=>handleDecreament(0)}>Reset</Button>
